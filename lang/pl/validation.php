...
return [
    ...
    */
    ...
    'custom' => [
        'start' => [
            'string' => 'Wymagane jest podanie daty pobytu.',
            'required' => 'Wymagane jest podanie daty pobytu.',
        ],
        'end' => [
            'string' => 'Wymagane jest podanie daty pobytu.',
            'required' => 'Wymagane jest podanie daty pobytu.',
        ...
        'apartment_id' => [
            'required' => 'Wymagane jest wybranie domku.',
            'numeric' => 'Wymagane jest wybranie domku.',
            'integer' => 'Wymagane jest wybranie domku.',
            'exists:apartments,id' => 'Wymagane jest wybranie domku.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'apartment_id' => 'domek',
        'start' => 'data zameldowania',
        'end' => 'data wymeldowania',
    ],
];
